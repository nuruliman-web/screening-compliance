...
# Kita langsung taruh judul dan menu di paling atas file agar PASTI MUNCUL
...
if uploaded_file1 is not None:
    try:
        ...
        # Jika hasil filter tidak kosong, kita proses datanya
        if not df_filtered.empty:
            st.success(f"✅ Berhasil memproses data! Ditemukan {len(df_filtered)} nasabah baru.")

            # 4. Pembersihan Data Kolom Hijau yang Ditentukan
