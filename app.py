...
def login_screen():
    # HEADER GAMBAR DAN TEKS SUDAH DIHAPUS TOTAL
...
def main_interface():
    # Header Info & Logout (Layout Lebar)
    ...
    # Menu Tabs (Tetap Fullscreen tanpa Sidebar)
    if st.session_state['role'] == "Admin":
        tabs = st.tabs(["🔍 Single Screening", "🚀 Bulk Screening", "📊 KYC Dashboard", "📝 Log Kegiatan", "👥 User Management", "🕒 Admin Log"])
        ...
        tabs = st.tabs(["🔍 Single Screening", "🚀 Bulk Screening", "📊 KYC Dashboard", "📝 Log Kegiatan"])
